...
TARGET_DATA_OTICS = {
    ...
    "PV ENERGY_Today":          '//*[@id="day"]',
    "PV ENERGY_Monthly":        '//*[@id="month"]',
    "PV ENERGY_Total":          '//*[@id="ttlEnergy"]',
    "Irradiation":              '//*[@id="irr"]',
    "PR":                       '//*[@id="pr"]',
    "WEATHER FOR CIKARANG_TEMP":'//*[@id="w_temp"]',
    "WEATHER FOR CIKARANG_DATE":'//*[@id="w_time"]',
    "CO2_Reduced":              '//*[@id="co2"]',
    "STATUS":                   '//*[@id="w_status"]/span',
    "COMM. MONITORING_last":    '//*[@id="tgl"]'
}
...
TARGET_DATA_HUAWEI = {
    ...
    "Yield Today":              '//*[@id="root"]/div/div/div/div/div[3]/div[2]/div/div/div[3]/div[2]/div/div[1]/div/div[1]/div/div[2]/div[1]/div/div[1]/span',
    "Supply From Grid Today":   '//*[@id="root"]/div/div/div/div/div[3]/div[2]/div/div/div[3]/div[2]/div/div[1]/div/div[1]/div/div[2]/div[2]/div/div[1]/span',
    "Total Yield":              '//*[@id="root"]/div/div/div/div/div[3]/div[2]/div/div/div[3]/div[2]/div/div[1]/div/div[1]/div/div[2]/div[3]/div/div[1]/span',
    "Inverter Rated Power":     '//*[@id="root"]/div/div/div/div/div[3]/div[2]/div/div/div[3]/div[2]/div/div[1]/div/div[1]/div/div[2]/div[4]/div/div[1]/span',
    "Installed PV Capacity":    '//*[@id="root"]/div/div/div/div/div[3]/div/div[2]/div[3]/div/div[1]/div[2]/div[1]/div[3]/span[1]',
    "Standard Coal Saved":      '//*[@id="root"]/div/div/div/div/div[3]/div[2]/div/div/div[3]/div[2]/div/div[1]/div/div[3]/div[2]/div[1]/div/div[1]/span',
    "CO2 Avoided":              '//*[@id="root"]/div/div/div/div/div[3]/div[2]/div/div/div[3]/div[2]/div/div[1]/div/div[3]/div[2]/div[2]/div/div[1]/span',
    "EquivalentTrees Planted":  '//*[@id="root"]/div/div/div/div/div[3]/div[2]/div/div/div[3]/div[2]/div/div[1]/div/div[3]/div[2]/div[3]/div/div[1]/span'
}
...
def save_to_json(new_data):
    ...
    # 2. STATIC POINTER untuk React Dashboard
    ...
    with open(filename_statis, 'w') as file_statis:
        json.dump(all_data, file_statis, indent=4)
        ...
        while True:
            ...
            for name, xpath in TARGET_DATA_HUAWEI.items():
                try:
                    ...
                    if name in ("Yield Today", "Supply From Grid Today", "Total Yield",
                                "Inverter Rated Power", "Standard Coal Saved",
                                "CO2 Avoided", "EquivalentTrees Planted"):
